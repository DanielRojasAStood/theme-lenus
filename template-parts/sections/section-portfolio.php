...
?>
<section class="sectionDownloadPortfolio">
    <div class="container--large">
        <div class="sectionDownloadPortfolio__info">
            <?php if($heading) :?>
                <h2 class="heading--48 line line--blue line--center"><?php echo $heading; ?></h2>
            <?php endif; ?>
        
            <?php if($enlace_title) : ?>
                <div class="sectionDownloadPortfolio__cta">
                    <a class="button button--blue" href="<?php echo $enlace_url; ?>" class="btn btn-primary cta" title="<?php echo $enlace_title; ?>" target="<?php echo $enlace_target; ?>"><?php echo $enlace_title; ?></a>
                </div>
            <?php endif; ?>
            <div class="sectionDownloadPortfolio__img">
